...
if __name__ == '__main__':
    ...
    end_date_OOS = datetime.datetime(2020, 6, 16)
    ...
    sharpe_index_ = obj_portfolio_index.create_index_list(weighted_ret_sharpe,[])
    mean_var_index_ = obj_portfolio_index.create_index_list(weighted_ret_mean_var,[])
    BL_mean_var_index_ = obj_portfolio_index.create_index_list(weighted_ret_BL_mean_var,[])
    BL_sharpe_index_ = obj_portfolio_index.create_index_list(weighted_ret_BL_sharpe,[])
    ...
    sharpe_index_OOS = obj_portfolio_index.create_index_list(weighted_ret_sharpe_OOS,sharpe_index_)
    mean_var_index_OOS = obj_portfolio_index.create_index_list(weighted_ret_mean_var_OOS,mean_var_index_)
    BL_mean_var_index_OOS = obj_portfolio_index.create_index_list(weighted_ret_BL_mean_var_OOS,BL_mean_var_index_)
    BL_sharpe_index_OOS = obj_portfolio_index.create_index_list(weighted_ret_BL_sharpe_OOS,BL_sharpe_index_)
